...
TEST(GamemoveMovePile, ApplyMoveToBoard)
{
    ...
    game::GamemoveMovePile moveMovePile(game::Position(0, 0), game::Position(1, 1));
    ...
    EXPECT_CALL(mockBoard, MovePile(game::Position(0, 0), game::Position(1, 1))).Times(1);

    std::unique_ptr<game::IGameState> resultState = moveMovePile.ApplyOnGamestate(mockGameState1);
