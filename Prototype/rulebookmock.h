...
public:
    ...
    std::vector<std::shared_ptr<Gamemove>>
        GetPossibleMoves(const std::shared_ptr<GameState> currentState) const override;
    int HasSomeoneWon(const std::shared_ptr<GameState> currentState) const override;
};
